...
public final class CCHQSoundPhysicsCompat {
    ...
    public static final String VERSION = "0.1.0-beta11-rc1";
    ...
    public CCHQSoundPhysicsCompat(ModContainer container) {
        ...
        container.registerConfig(ModConfig.Type.CLIENT, SpectralMixConfig.SPEC, "cchq_soundphysics_compat-sync-balance.toml");
        container.registerConfig(ModConfig.Type.CLIENT, DiffractionConfig.SPEC, "cchq_soundphysics_compat-openings.toml");
        container.registerExtensionPoint(IConfigScreenFactory.class, ConfigScreenFactory::create);
        DebugCommands.init();
        LOGGER.info("CC:HQ Sound Physics Compat {} initialized", VERSION);
