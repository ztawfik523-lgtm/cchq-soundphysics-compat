...
public final class CCHQSoundPhysicsCompat {
    ...
    public static final String VERSION = "0.1.0-beta11-phase5-diffraction-v2-test";
    ...
    public CCHQSoundPhysicsCompat(ModContainer container) {
        ...
        // Separate file: this experiment is OFF by default and must never silently become part of the approved HF50 baseline.
        container.registerConfig(ModConfig.Type.CLIENT, DiffractionConfig.SPEC, "cchq_soundphysics_compat-diffraction-test.toml");
        container.registerExtensionPoint(IConfigScreenFactory.class, ConfigScreenFactory::create);
        DebugCommands.init();
        LOGGER.info("CC:HQ Sound Physics Compat {} initialized; HF50 baseline preserved, vertical diffraction V2 test available and OFF by default", VERSION);
