...
public final class CCHQSoundPhysicsCompat {
    ...
    public static final String VERSION = "0.1.0-beta11-phase5-diffraction-test";
    ...
    public CCHQSoundPhysicsCompat(ModContainer container) {
        ...
        DebugCommands.init();
        LOGGER.info("CC:HQ Sound Physics Compat {} initialized; HF50 baseline preserved, vertical diffraction test available and OFF by default", VERSION);
